...
class $AssetsFontsGen {
  ...
  /// File path: assets/fonts/stolzl_light.otf
  String get stolzlLight => 'assets/fonts/stolzl_light.otf';
  ...
  /// List of all assets
  List<String> get values => [stolzlBold, stolzlLight, stolzlMedium, stolzlRegular];
}

class $AssetsIconsGen {
  const $AssetsIconsGen();

  /// File path: assets/icons/add-product.svg
  SvgGenImage get addProduct => const SvgGenImage('assets/icons/add-product.svg');
  ...
  /// List of all assets
  List<SvgGenImage> get values => [addProduct, bell, delivery, fire, home, mark, message, profile, shop];
}
